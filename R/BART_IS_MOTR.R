#' @title BART-IS-MOTR
#'
#' @description A parallelized implementation of BART-IS-MOTR
...
#'
#'
#' examplepreds1 <- BART_IS_MOTR(seed1,
#'                                    y, xcov,xcovtest,
#'                                    lambda=0.45,
...
BART_IS_MOTR <- function(seed,
  ...
  sBART_M_output=BART_MOTR_IS_cpp(lambda,
                                       num_models,
                                       num_trees,
                                       seed,
                                       y,
