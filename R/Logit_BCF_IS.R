#' @title Parallel Logit Bayesian Causal Forest
#' @description A parallelized implementation of Logit-BCF-IS
...
Logit_BCF_IS <- function(seed,
  ...
  L_bcf_output=LBCF_IS(lambda_mu,
                       lambda_tau,
                       num_models,
                       num_trees_mu,
                       num_trees_tau,
