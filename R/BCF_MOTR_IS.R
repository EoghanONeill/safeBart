#' @title Parallel BCF-MOTR-IS with CATE estimate and prediction intervals
#'
#' @description A parallelized implementation of BCF-MOTR-IS
...
BCF_MOTR_IS <- function(seed,
  ...
  sBCF_M_output=BCF_MOTR_IS_cpp(lambda_mu,
                                     lambda_tau,
                                     num_models,
                                     num_trees_mu,
                                     num_trees_tau,
